...
<!-- [![GitHub tag](https://badgen.net/github/tag/echasnovski/mini.comment)](https://github.com/echasnovski/mini.comment/tags/) -->
<!-- [![Current version](https://badgen.net/badge/Current%20version/development/cyan)](https://github.com/echasnovski/mini.comment/blob/main/CHANGELOG.md) -->
<!-- badges: end -->

**Fast and familiar per-line commenting**

See more details in [help file](doc/mini-comment.txt).
